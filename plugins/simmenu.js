...
const fkgif = {
	 ...
	 { remoteJid: "6283894063406-1625305606@g.us" } : {}) 
                },
	 message: { 
		"extendedTextMessage": {
                 "text":`SoftBOTz MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `SoftBOTz MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
...
●────━───༺༻───━────●
                *《 BOT INFO 》*
⚘ *Bot Name: SoftBOTz-MD*
⚘ *Creator: SofatiXD*
⚘ *Contact Owner Bot*
*http://wa.me/6283894063406*
⚘ *Tanggal: ${date}*  
⚘ *Jam: ${time} WIB*
⚘ *Status: 「 ${mode} 」*
⚘ *Prefix: 「 MULTI PREFIX 」*
